...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-col gap-6 mx-auto p-6 bg-background border border-border rounded-lg shadow-lg w-[600px]">
      <div className="flex flex-col gap-6">
        <div className="flex flex-col items-center gap-2">
          ...
          <h1 className="text-xl font-bold">Welcome to ACCM.</h1>
